 ...
 */
void
Haptic_Feedback(char *name, int effect_volume, int sound_volume, int effect_duration, int effect_x, int effect_y, int effect_z)
{
	...
	{
		Com_Printf("%s: volume %d[%d]:%d ms\n", name,  sound_volume, effect_volume, effect_duration);
